...
<head>
    ...
    <link rel='stylesheet' id='woocommerce-general-css' href='{{ asset('wp-content/plugins/woocommerce/assets/css/woocommerce-layoutd3a6.css') }}' type='text/css' media='all' />
    <link rel='stylesheet' id='woocommerce-general-css' href='{{ asset('wp-content/plugins/woocommerce/assets/css/woocommerced3a6.css') }}' type='text/css' media='all' />
    ...
    $(document).ready(function() {
        ...
        function bindAllMiniCartEvents() {
            ...
            $(document).off('click', '.mini-cart-plus').on('click', '.mini-cart-plus', function(e) {
                ...
                var input = $(this).closest('.quantity').find('input.mini-cart-quantity[data-product-id="' + productId + '"]');
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        showNotification(response.message || 'Erro ao adicionar ao carrinho', 'error');
                    }
                },
                error: function (xhr) {
                    showNotification('Erro de conexão', 'error');
        ...
        document.querySelectorAll('.wishlist-button').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                if (isAdded) {
                    ...
                    addToWishlist(productId, productTitle, productPrice, productImage, productSlug, this);
                }
            });
        });
            ...
            fetch('{{ route("wishlist.add") }}', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        button.querySelector('.yith-wcwl-add-to-wishlist-button__label').textContent = 'Dans la liste';
            ...
            fetch('{{ route("wishlist.remove") }}', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        button.querySelector('.yith-wcwl-add-to-wishlist-button__label').textContent = 'Add to wishlist';
