voici la strucuture de ma page selon toi quelle sont les lient qui ne serve a rien dans ce code : <!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">

<head>
    <meta charset="UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <title>Tugas Lenha &#8211; Compre a sua lenha, pellets de madeira e fogão a lenha com a Tugas Lenha</title>
    ...
    <link rel='stylesheet' id='chosen-drop-down-css'
          href="{{ asset('wp-content/plugins/woocommerce-products-filter/js/chosen/chosen.min22ef.css') }}" type='text/css'
          media='all'/>
    ...
    <link rel='stylesheet' id='woocommerce-smallscreen-css'
          href="{{ asset('wp-content/plugins/woocommerce/assets/css/woocommerce-smallscreend3a6.css') }}" type='text/css'
          media='only screen and (max-width: 768px)'/>
    <link rel='stylesheet' id='woocommerce-general-css'
          href="{{ asset('wp-content/plugins/woocommerce/assets/css/woocommerced3a6.css') }}" type='text/css' media='all'/>
    ...
    <link rel='stylesheet' id='woocommerce_prettyPhoto_css-css'
          href="{{ asset('wp-content/plugins/woocommerce/assets/css/prettyPhoto005e.css') }}" type='text/css' media='all'/>
    ...
    <link rel='stylesheet' id='brands-styles-css'
          href="{{ asset('wp-content/plugins/woocommerce/assets/css/brandsd3a6.css') }}" type='text/css' media='all'/>
    ...
    <link rel='stylesheet' id='elementor-frontend-css'
          href="{{ asset('wp-content/plugins/elementor/assets/css/frontend.min4bf6.css') }}" type='text/css' media='all'/>
    ...
    <link rel='stylesheet' id='maia-template-css' href="{{ asset('wp-content/themes/maia/css/template5152.css') }}"
          type='text/css' media='all'/>
    <link rel='stylesheet' id='maia-style-css' href="{{ asset('wp-content/themes/maia/style5152.css') }}" type='text/css'
          media='all'/>
    ...
    <link rel='stylesheet' id='material-design-iconic-font-css'
          href="{{ asset('wp-content/themes/maia/css/material-design-iconic-font3601.css') }}" type='text/css' media='all'/>
    <link rel='stylesheet' id='animate-css' href="{{ asset('wp-content/themes/maia/css/animate3b71.css') }}" type='text/css'
          media='all'/>
    <link rel='stylesheet' id='jquery-treeview-css' href="{{ asset('wp-content/themes/maia/css/jquery.treeview8a54.css') }}"
          type='text/css' media='all'/>
    <link rel='stylesheet' id='magnific-popup-css' href="{{ asset('wp-content/themes/maia/css/magnific-popupf488.css') }}"
          type='text/css' media='all'/>
    <link rel='stylesheet' id='maia-child-style-css' href="{{ asset('wp-content/themes/maia-child/style2be9.css') }}"
          type='text/css' media='all'/>
    ...
    <script type="text/javascript"
            src="{{ asset('wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min5aa6.js') }}"
            id="wc-js-cookie-js" defer="defer" data-wp-strategy="defer"></script>

    <script type="text/javascript"
            src="{{ asset('wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.mind3a6.js') }}"
            id="woocommerce-js"
    ...
    <link rel="icon" href="{{ asset('wp-content/uploads/2025/10/cropped-er-04-192x192.png') }}" sizes="192x192"/>
    ...
    <link href="{{ asset('wp-content/plugins/revslider/public/css/fonts/revicons/css/revicons.css') }}" rel="stylesheet"
...
<script type="text/javascript" src="{{ asset('wp-includes/js/api-request.mind4d0.js') }}" id="wp-api-request-js"></script>
...
<script type="text/javascript" src="{{ asset('wp-includes/js/dist/api-fetch.min7cb7.js') }}" id="wp-api-fetch-js"></script>
...
<script type="text/javascript" src="{{ asset('wp-includes/js/dist/vendor/lodash.mind1d1.js') }}"
        id="lodash-js"></script>

<script type="text/javascript" src="{{ asset('wp-includes/js/dist/vendor/moment.minf799.js') }}"
        id="moment-js"></script>

<script type="text/javascript" src="{{ asset('wp-includes/js/dist/deprecated.min0a8b.js') }}" id="wp-deprecated-js"></script>
...
<script type="text/javascript" src="{{ asset('wp-includes/js/dist/vendor/react.mine1ab.js') }}"
        id="react-js"></script>

<script type="text/javascript" src="{{ asset('wp-includes/js/dist/vendor/react-dom.mine1ab.js') }}"
...
<script type="text/javascript" src="{{ asset('wp-content/themes/maia/js/functions.min5152.js') }}"
        id="maia-script-js"></script>
...
<script type="text/javascript" src="{{ asset('wp-includes/js/jquery/ui/core.minb37e.js') }}"
...
<script type="text/javascript" src="{{ asset('wp-content/themes/maia/js/popper.mind57f.js') }}" id="popper-js"></script>
<script type="text/javascript" src="{{ asset('wp-content/themes/maia/js/bootstrap.minc721.js') }}"
