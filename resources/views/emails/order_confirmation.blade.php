...
<head>
    ...
    <style>
        ...
        .address-box { background: #f8f9fa; padding: 15px; border-left: 4px solid #2c3e50; margin: 10px 0; }
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Obrigado por escolher Tugas Lenha!</p>
    </div>

    <div class="footer">
        <p>Tugas Lenha &copy; {{ date('Y') }}</p>
        <p>Se tiver alguma questão, contacte-nos: info@tugas-lenha.com</p>
    </div>
</div>
</body>
</html>
