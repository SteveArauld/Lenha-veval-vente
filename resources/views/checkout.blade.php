                                    ...
                                    <div
                                        ...
                                        <!-- Champs cachés pour les méthodes -->
                                            ...
                                            <fieldset
                                                ...
                                                <div class="wc-block-components-checkout-step__heading"><h2
                                                ...
                                                <div class="wc-block-components-checkout-step__container"><p
                                                        class="wc-block-components-checkout-step__description">Usaremos
                                                            ...
                                                            <div
                                                                ...
                                                                <label for="checkbox-control-0"><input
                                                                    ...
                                                                    <svg class="wc-block-components-checkbox__mark"
                                                                         ...
                                                                         viewBox="0 0 24 20">
                                                                        <path
                                                                            d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"></path>
                                                                    </svg>
                                                                    <span class="wc-block-components-checkbox__label">Criar uma conta com Tugas Lenha</span></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <fieldset
                                                ...
                                                <div class="wc-block-components-checkout-step__heading"><h2
                                                        class="wc-block-components-title wc-block-components-checkout-step__title">
                                                        Morada de envio</h2></div>
                                                <div class="wc-block-components-checkout-step__container"><p
                                                        class="wc-block-components-checkout-step__description">Introduza
                                                    ...
                                                    <div class="wc-block-components-checkout-step__content">
                                                            ...
                                                            <div class="wc-block-components-address-card-wrapper">
                                                                <div class="wc-block-components-address-card">
                                                                    ...
                                                                    <span type="button"
                                                                          ...
                                                                          tabindex="0" role="button">Editar</span></div>
                                                            </div>
                                                                ...
                                                                <div id="shipping"
                                                                        ...
                                                                        <div class="wc-blocks-components-select">
                                                                            <div
                                                                                ...
                                                                                <svg viewBox="0 0 24 24"
                                                                                     ...
                                                                                     focusable="false">
                                                                                    <path
                                                                                        d="M17.5 11.6L12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z"></path>
                                                                                </svg>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <input type="text" id="shipping-first_name" name="shipping-first_name"
                                                                               ...
                                                                               aria-label="Nome" aria-describedby=""
                                                                               required="" aria-invalid="false" title=""
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="text" id="shipping-address_2" name="shipping-address_2"
                                                                               ...
                                                                               title="" value="{{ old('shipping-address_2') }}"
                                                                               placeholder=" ">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="tel" id="shipping-phone" name="shipping-phone"
                                                                               ...
                                                                               aria-describedby="" aria-invalid="false"
                                                                               title="" value="{{ old('shipping-phone') }}"
                                                                               placeholder=" ">
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="checkbox-control-1"><input
                                                                    id="checkbox-control-1"
                                                                    class="wc-block-components-checkbox__input"
                                                                    type="checkbox" aria-invalid="false" value=""
                                                                    checked="">
                                                                <svg class="wc-block-components-checkbox__mark"
                                                                ...
                                                                <span class="wc-block-components-checkbox__label">Usar o mesmo endereço para facturação</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset
                                                ...
                                                <div class="wc-block-components-checkout-step__heading"><h2
                                                        class="wc-block-components-title wc-block-components-checkout-step__title">
                                                        Morada de facturação</h2></div>
                                                <div class="wc-block-components-checkout-step__container"><p
                                                        class="wc-block-components-checkout-step__description">Digite o
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            class="wc-block-components-radio-control__label">Envio grátis</span><span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                class="wc-block-components-radio-control__label"><span
                                                                                    class="wc-block-components-payment-method-label">Transferência bancária</span></span>
                                                                        </div>
                                                                    </div>
                                                                </label>
                                                                <div
                                                                    id="radio-control-wc-payment-method-options-bacs__content"
                                                    ...
                                                    <div class="wc-block-components-checkout-step__content">
                                                        <div class="wc-block-checkout__add-note">
                                                            <div class="wc-block-components-checkbox"><label
                                                                    ...
                                                                    <span class="wc-block-components-checkbox__label">Adicione uma nota à sua encomenda</span></label>
                                                                ...
                                                                <textarea class="wc-block-components-textarea"
                                                                          ...
                                                                          rows="2">{{ old('order_notes') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <a href="{{ route('carrinho') ?: '#' }}"
                                                       class="wc-block-components-checkout-return-to-cart-button">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                             ...
                                                             focusable="false">
                                                            <path
                                                                d="M20 11.2H6.8l3.7-3.7-1-1L3.9 12l5.6 5.5 1-1-3.7-3.7H20z"></path>
                                                        </svg>
                                                        Voltar ao carrinho
                                                    </a>
                                                    <button
                                    ...
                                    <div
                                        ...
                                        <div class="wp-block-woocommerce-checkout-order-summary-block">
                                            <div class="wc-block-components-checkout-order-summary__title">
                                                ...
                                                <span
                                                    class="wc-block-formatted-money-amount wc-block-components-formatted-money-amount wc-block-components-checkout-order-summary__title-price">{{ $formattedTotalPrice }} €</span>
                                            ...
                                            <div class="wc-block-components-checkout-order-summary__content" id=":r1:">
                                                            ...
                                                            @foreach($cart as $productId => $item)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span aria-hidden="true">{{ $itemQuantity }}</span><span
                                                                            class="screen-reader-text">{{ $itemQuantity }} item item</span>
                                                                    </div>
                                                                    @if(!empty($item['image']))
                                                                    <img
                                                                ...
                                                                <div
                                                                    ...
                                                                    <h3 class="wc-block-components-product-name">{{ $item['title'] }}</h3><span
                                                                        class="wc-block-components-order-summary-item__individual-prices price wc-block-components-product-price"><span
                                                                            ...
                                                                            class="wc-block-components-product-price__regular wc-block-components-order-summary-item__regular-individual-price">{{ $item['old_price'] }} €</del><span
                                                                            class="screen-reader-text">Preço com desconto:</span><ins
                                                                            class="wc-block-components-product-price__value is-discounted wc-block-components-order-summary-item__individual-price">{{ $item['price'] }} €</ins></span>
                                                                    <div class="wc-block-components-product-metadata">
                                                                        <div
                                                                            class="wc-block-components-product-metadata__description">
                                                                            <p>{{ Str::limit($item['short_description'], 70) }}</p>

                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <span class="screen-reader-text">{{ $item['old_price'] }} €</span>
                                                                <div
                                                ...
                                                <div class="wp-block-woocommerce-checkout-order-summary-totals-block">
                                                    <div
                                                        ...
                                                        <div class="wc-block-components-totals-item">
                                                            ...
                                                            <span
                                                                class="wc-block-formatted-money-amount wc-block-components-formatted-money-amount wc-block-components-totals-item__value">{{ number_format($totalPrice, 3, ',', ' ') }} €</span>
                                                            <div
                                                                class="wc-block-components-totals-item__description"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="wc-block-components-totals-wrapper">
                                                    <div
                                                        ...
                                                        <span
                                                            class="wc-block-components-totals-item__label">Total</span>
                                                        <div class="wc-block-components-totals-item__value">
                                                            <span
                                                                class="wc-block-formatted-money-amount wc-block-components-formatted-money-amount wc-block-components-totals-footer-item-tax-value">{{ $formattedTotalPrice }} €</span>
                                                        </div>
 ...
 <script>
    $(document).ready(function () {
        ...
        function copyShippingToBilling() {
            const fields = ['first_name', 'last_name', 'address_1', 'address_2', 'city', 'postcode', 'country', 'phone'];
        ...
        $('#checkout-form').on('submit', function(e) {
            ...
            submitBtn.find('.wc-block-components-checkout-place-order-button__text').text('Processando...');
            ...
            requiredFields.forEach(field => {
                ...
                if (element.length && !element.val().trim()) {
                    ...
                    element.closest('.wc-block-components-text-input, .wc-blocks-components-select').append(
            ...
            if (email && !emailRegex.test(email)) {
                ...
                if (!$('#email').closest('.wc-block-components-text-input').find('.field-error').length) {
            ...
            if (!$('#terms-checkbox').is(':checked')) {
                ...
                if (!$('#terms-checkbox').closest('.wc-block-components-checkbox').find('.field-error').length) {
            ...
            if (!isValid) {
                ...
                submitBtn.find('.wc-block-components-checkout-place-order-button__text').text('Finalizar encomenda');
        ...
        function saveFormData() {
            const formData = {};
            const excludedFields = ['_token', 'csrf-token', '__token']; // Exclure tous les noms possibles de token
            ...
            $('#checkout-form input, #checkout-form select, #checkout-form textarea').each(function() {
                ...
                if (name && !excludedFields.includes(name)) {
                    if ($(this).attr('type') === 'checkbox') {
                        ...
                        formData[name] = $(this).val();
                    } else if ($(this).is('select, input[type="text"], input[type="email"], input[type="tel"], textarea')) {
